...
export default function Profile() {
  return (
    <div className="flex w-full flex-col items-center gap-2 sm:gap-3 md:gap-4 lg:gap-6 px-2 sm:px-3 md:px-4 pt-2 sm:pt-4 md:pt-6 lg:pt-8 text-center sm:flex-row sm:justify-center sm:text-left">
      {/* Avatar */}
